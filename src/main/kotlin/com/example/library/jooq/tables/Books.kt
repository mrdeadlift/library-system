...
import com.example.library.jooq.indexes.IDX_BOOKS_PRICE
import com.example.library.jooq.indexes.IDX_BOOKS_PUBLICATION_STATUS
import com.example.library.jooq.indexes.IDX_BOOKS_TITLE
import com.example.library.jooq.keys.BOOKS_PKEY
import com.example.library.jooq.keys.BOOK_AUTHORS__BOOK_AUTHORS_BOOK_ID_FKEY
import com.example.library.jooq.tables.Authors.AuthorsPath
import com.example.library.jooq.tables.BookAuthors.BookAuthorsPath
import com.example.library.jooq.tables.records.BooksRecord
...
open class Books(
     ...
     */
    val PUBLICATION_STATUS: TableField<BooksRecord, PublicationStatus?> = createField(DSL.name("publication_status"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field(DSL.raw("'UNPUBLISHED'::publication_status"), SQLDataType.VARCHAR)).asEnumDataType(PublicationStatus::class.java), this, "")
    ...
    override fun getIndexes(): List<Index> = listOf(IDX_BOOKS_PRICE, IDX_BOOKS_PUBLICATION_STATUS, IDX_BOOKS_TITLE)
    ...
    override fun getChecks(): List<Check<BooksRecord>> = listOf(
        Internal.createCheck(this, DSL.name("chk_price_non_negative"), "((price >= (0)::numeric))", true)
    )
