...
import com.example.library.jooq.indexes.IDX_AUTHORS_NAME
import com.example.library.jooq.keys.AUTHORS_PKEY
...
open class Authors(
    ...
    override fun getChecks(): List<Check<AuthorsRecord>> = listOf(
        Internal.createCheck(this, DSL.name("chk_birth_date_past"), "((birth_date < CURRENT_DATE))", true)
    )
